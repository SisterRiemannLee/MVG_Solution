...
%% SO(3)
% write a function that tranform a vector to its correspondinfg element in
% Lie group ~ compute exponential
R1 = Exp_SO3(w1);
R2 = Exp_SO3(w2);

% write a function that performs the inverse transformation ~ compute 
% logarithm to get back to the original value
w1_b = Log_SO3(R1);
w2_b = Log_SO3(R2,0);
